        ...
        | Some({image: Some({relativePath, _}), alt}) =>
          <div className="entry-page__avatar-wrapper">
            <div
              ...
              <img
                src={"https://res.cloudinary.com/bike-walk-life/image/upload/c_fill,g_center,h_120,w_120/v1608060004/gatsby-cloudinary/" ++
                relativePath}
                srcSet={`
                https://res.cloudinary.com/bike-walk-life/image/upload/c_fill%2Cg_center%2Ch_120%2Cw_120/v1608060004/gatsby-cloudinary/${relativePath} 1x,
                https://res.cloudinary.com/bike-walk-life/image/upload/c_fill%2Cg_center%2Ch_180%2Cw_180/v1608060004/gatsby-cloudinary/${relativePath} 1x,
                https://res.cloudinary.com/bike-walk-life/image/upload/c_fill%2Cg_center%2Ch_240%2Cw_240/v1608060004/gatsby-cloudinary/${relativePath} 2x
                `}
                ?alt
                height="120"
                width="120"
    ...
    <Layout
      metadata={Article({
        ...
        | Some({alt, image: Some({relativePath, _}), _}) =>
          Some({
            url: {
              "https://res.cloudinary.com/bike-walk-life/image/upload/c_fill,g_auto,h_450,w_900/v1608060004/gatsby-cloudinary/" ++
              relativePath
            },
            alt: alt,
          })
