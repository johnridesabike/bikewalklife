---
title: Georgia Bikes launches a new crash data dashboard
author: John Jackson
...
[You can view the Georgia Bikes crash data dashboard here](https://georgiabikes.org/crash-data/).

[![A screenshot of the Georgia Bikes crash data dashboard.](https://res.cloudinary.com/bike-walk-life/image/upload/v1682595328/2023/gabikescrashdashboard_grrjkq.png)](https://georgiabikes.org/crash-data/)
...
This launch comes just after [the NHTSA released their data showing that nationwide bicycle and pedestrian fatalities have hit a 40 year high](https://bikewalk.life/2023/04/new-nhtsa-report-shows-pedestrian-and-bicycle-fatalities-hit-a-40-year-high/). It's a grim reality that we have so much crash data that we need more sophisticated tools to analyze it, but hopefully dashboards like this can help empower us to make our streets safer for everyone.
