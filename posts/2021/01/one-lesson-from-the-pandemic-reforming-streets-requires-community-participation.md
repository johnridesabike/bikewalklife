---
date: 2021-01-14T09:18:31-05:00
draft: false
title: 'One lesson from the pandemic: reforming streets requires community participation'
author: John Jackson
hero_image:
  image: ''
  alt: ''
...
[Bloomberg CityLab has an article by Laura Bliss](https://www.bloomberg.com/news/articles/2021-01-06/the-swift-disruptive-rise-of-slow-streets) which describes how these swift projects actually disrupted some of the communities they aimed to help. She uses an example from Oakland:
...
Unfortunately, this isn’t an uncommon pattern. In 2019, Detroit received pushback against its free tree planting program for similar reasons, as [Bloomberg also reported](https://www.bloomberg.com/news/articles/2019-01-11/why-detroiters-didn-t-trust-city-tree-planting-efforts). The problem then wasn’t the trees themselves, it was the fact that the city wasn’t communicating with residents, and residents didn’t implicitly trust the city.
...
The story on street closures is a bit more complex than free trees, though. Bliss explains in her article that many cities' poorer residents were _more_ car-dependent during the pandemic than before, so closing streets to cars was counter-intuitive. Another issue is that street “safety” in the context of the George Floyd protests means much more than simply getting rid of cars.
...
Another article from 2020, [Towards a More Inclusive Urbanism](https://www.theamericanconservative.com/urbs/towards-a-more-inclusive-urbanism/), has some criticism on the broader issue:
