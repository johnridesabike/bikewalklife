...
One thing about Braess’s paradox is that it’s not simply observational. It’s based on mathematics. Like all paradoxes, it only _seems_ counter-intuitive on the surface, but it’s actually logically sound. In fact, we have formulas for calculating exactly how the paradox works. ([Wikipedia has a wealth of explanation](https://en.wikipedia.org/wiki/Braess%27s_paradox).)
