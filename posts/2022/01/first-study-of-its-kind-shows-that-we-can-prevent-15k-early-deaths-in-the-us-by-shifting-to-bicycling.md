...
---
A new study aims to quantify the health benefits of a shift to bicycling in 17 countries around the world. In its "ambitious high bike use" scenario, 205,424 early deaths would be prevented globally, with 15,309 in the United States. And those numbers are a conservative estimate.

The paper, published late 2021, is titled [Premature Mortality of 2050 High Bike Use Scenarios in 17 Countries](https://doi.org/10.1289/EHP9073). It analyzes the health benefits of bicycling compared to its risks of traffic violence and breathing air pollution.

It turns out that the health benefits outweigh everything else, and it's not even close. This chart shows how physical activity saves far more lives than the other risks combined, based on a mere 8% car trips replaced by bikes:
