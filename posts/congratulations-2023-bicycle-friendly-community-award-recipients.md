...
[You can see the official announcement here with the full list of awards](https://bikeleague.org/league-of-american-bicyclists-recognizes-45-cities-and-towns-with-new-and-renewing-bicycle-friendly-community-awards/).

!["Bicycle Friendly Communities by Rank" chart. As of Spring 2023, 506 communities are currently recognized as a Bronze, Silver, Gold, or Platinum Bicycle Friendly Community. See the full list of BFCs at bikeleague.org/community.](https://res.cloudinary.com/bike-walk-life/image/upload/v1685658861/2023/BFC_by_rank_Spring_2023_sko9fp.jpg)

My own city, Columbus Georgia, was on this year's list and renewed its Bronze level. Columbus has been Bronze since 2014, and many of us had hoped for an upgrade to Silver. We've built a huge amount of infrastructure in the past several years and strengthened our local bike culture, so it seemed fair to recognize that with an upgraded BFC status. The Bike League does not disclose their exact reasons for every award given, but [they did raise their standards last year](https://bikeleague.org/enhanced-bicycle-friendly-community-application-raises-standards-places-seeking-awards/), which likely contributed to us receiving only a renewal rather than an upgrade.
