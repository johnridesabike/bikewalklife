---
date: 2020-12-11T18:56:29-05:00
draft: true
title: Why do people drive so much? Because we pay them to drive.
author: John Jackson
hero_image:
  image: ''
  alt: ''
...
---
It’s no secret that we subsidize driving to a degree that’s vastly disproportionate to other kinds of transportation. [Joe Cortright has a great piece in City Observatory that discusses this problem](https://cityobservatory.org/the-only-reason-some-people-drive-is-because-we-pay-them-to/).

> The biggest problem with transportation is we don’t price road use correctly, to reflect back to road users the costs that their decisions impose on society and everyone else traveling. In essence, we have daily urban traffic jams for the same reason [Ben and Jerry](http://cityobservatory.org/benjerry-2018/) have long lines on their annual _Free Cone Day_: when you don’t price something valuable, it gets rationed by queuing and patience. What’s worse is a lot of people who are driving on many roads at the rush hour is essentially because we are paying them to do so.
...
For decades, our public policy (and public opinion) has prioritized getting as many people driving cars as possible. The success of this plan has only revealed that it wasn't actually the ideal goal we had assumed it was. Any long-term transportation planning now needs to look beyond cars as the endgame. One good way to start is by ending driving subsidization.